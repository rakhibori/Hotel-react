...
const StandardGardenBalconySearch = () => {
    const {data: rooms, isLoading, isError, error} = useGetSampleRoomsQuery()
    ...
    const myRoom = rooms.filter(room => room.name === "استاندارد گاردن بالکنی")
...
export default StandardGardenBalconySearch; 
