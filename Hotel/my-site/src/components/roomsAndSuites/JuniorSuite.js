...
import JuniorSuiteSlider from './JuniorSuiteSlider';
import { useNavigate } from 'react-router-dom';

const JuniorSuite = ({rooms}) => {
    const room = rooms.filter(room => room.link === '/JuniorSuite')
                ...
                room.map(item=>(
                    <div className='standardDoubleRoomBox'>
                        ...
                        <div className='btnRezervBox'>
                            ...
                            <div>
                                <button onClick={()=>navigate('/juniorsuitesearch')}>همین الان رزرو کنید</button>
                            </div>
                        </div>
