...
import SuiteSignaturePlusSlider from './SuiteSignaturePlusSlider';
import { useNavigate } from 'react-router-dom';

const SuiteSignaturePlus = ({rooms}) => {
    const room = rooms.filter(room => room.link === '/SuiteSignaturePlus')
                ...
                room.map(item=>(
                    <div className='standardDoubleRoomBox'>
                        ...
                        <div className='btnRezervBox'>
                            ...
                            <div>
                                <button onClick={()=>navigate('/suitesignatureplussearch')}>همین الان رزرو کنید</button>
                            </div>
                        </div>
...
export default SuiteSignaturePlus;