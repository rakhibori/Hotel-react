...
import SuiteSkySlider from './SuiteSkySlider';
import { useNavigate } from 'react-router-dom';

const SuiteSky = ({rooms}) => {
    const room = rooms.filter(room => room.link === '/SuiteSky')
                ...
                room.map(item=>(
                    <div className='standardDoubleRoomBox'>
                        ...
                        <div className='btnRezervBox'>
                            ...
                            <div>
                                <button onClick={()=>navigate('/suiteskysearch')}>همین الان رزرو کنید</button>
                            </div>
                        </div>
