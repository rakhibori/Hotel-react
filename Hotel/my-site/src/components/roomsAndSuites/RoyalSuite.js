...
import RoyalSuiteSlider from './RoyalSuiteSlider';
import { useNavigate } from 'react-router-dom';

const RoyalSuite = ({rooms}) => {
    const room = rooms.filter(room => room.link === '/RoyalSuite')
                ...
                room.map(item=>(
                    <div className='standardDoubleRoomBox'>
                        ...
                        <div className='btnRezervBox'>
                            ...
                            <div>
                                <button onClick={()=>navigate('/royalsuitesearch')}>همین الان رزرو کنید</button>
                            </div>
                        </div>
