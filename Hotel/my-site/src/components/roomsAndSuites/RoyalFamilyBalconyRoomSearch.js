...
const RoyalFamilyBalconyRoomSearch = () => {
    ...
    const myRoom = sampleRoom.filter(room => room.name === "اتاق بالکن دار رویال خانوادگی")
...
export default RoyalFamilyBalconyRoomSearch; 
