...
import SuiteSignatureSlider from './SuiteSignatureSlider';
import { useNavigate } from 'react-router-dom';

const SuiteSignature = ({rooms}) => {
    const room = rooms.filter(room => room.link === '/SuiteSignature')
                ...
                room.map(item=>(
                    <div className='standardDoubleRoomBox'>
                        ...
                        <div className='btnRezervBox'>
                            ...
                            <div>
                                <button onClick={()=>navigate('/suitesignaturesearch')}>همین الان رزرو کنید</button>
                            </div>
                        </div>
