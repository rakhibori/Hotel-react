...
import RoyalFamilyBalconyRoomSlider from './RoyalFamilyBalconyRoomSlider';
import { useNavigate } from 'react-router-dom';

const RoyalFamilyBalconyRoom = ({rooms}) => {
    const room = rooms.filter(room => room.link === '/RoyalFamilyBalconyRoom')
                ...
                room.map(item=>(
                    <div className='standardDoubleRoomBox'>
                        ...
                        <div className='btnRezervBox'>
                            ...
                            <div>
                                <button onClick={()=>navigate('/royalfamilybalconyroomsearch')}>همین الان رزرو کنید</button>
                            </div>
                        </div>
...
export default RoyalFamilyBalconyRoom;