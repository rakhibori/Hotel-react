...
const Room = ({entryDate, exitDate, stayingTime, flagRezerv, setFlagRezerv, selectedMyRoom, setSelectedMyRoom, room, name, price, people, image, bed, extera_person, capacity, additional_service, breakfast, description, possibilities}) => {
