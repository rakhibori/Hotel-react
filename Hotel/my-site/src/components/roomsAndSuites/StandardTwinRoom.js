...
import StandardTwinRoomSlider from './StandardTwinRoomSlider';
import { useNavigate } from 'react-router-dom';

const StandardTwinRoom = ({rooms}) => {
    const room = rooms.filter(room => room.link === '/StandardTwinRoom')
                ...
                room.map(item=>(
                    <div className='standardDoubleRoomBox'>
                        ...
                        <div className='btnRezervBox'>
                            ...
                            <div>
                                <button onClick={()=>navigate('/standardtwinroomsearch')}>همین الان رزرو کنید</button>
                            </div>
                        </div>
...
export default StandardTwinRoom;