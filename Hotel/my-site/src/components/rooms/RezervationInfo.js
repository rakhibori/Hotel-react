...
const RezervationInfo = ({selectedMyRoom, entryDate, exitDate, stayingTime, setBookersRoom}) => {
    ...
    const handleRezerv = () => {
        if(form.values.name !== '' & form.values.family !== '' & form.values.mobile !== ''){
            setBookersRoom({name: form.values.name, family: form.values.family, mobile: form.values.mobile, entryDate: entryDate, exitDate: exitDate, stayingTimeHotel:night})
            createUsersRooms({name: form.values.name, family: form.values.family, mobile: form.values.mobile, nationalCode: form.values.nationalCode, email: form.values.email, stayingTimeHotel: night, entryDate: entryDate, exitDate: exitDate, roomsSelected: selectedMyRoom})
