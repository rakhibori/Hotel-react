...
const DisplayRezervationInfo = ({bookersRoom, selectedMyRoom, stayingTime, night, setNight}) => {
            ...
            <div className='displayRezervationInfoMainBox'>
                ...
                <div className='displayRezervationInfoPerson'>
                    ...
                    <div className='displayRezervationInfoPersonHotelBox'>
                        ...
                        <div className='hotelBox'>{bookersRoom.exitDate}</div>
                    </div>
                    <div className='displayRezervationInfoPersonHotelBox'>
                        <div className='hotelBox'>به مدت</div>
                        <div className='hotelBox'>{bookersRoom.stayingTimeHotel} شب</div>
                    </div>
                    <div className='displayRezervationInfoPersonHotelBox'>
                ...
                <div>
                    ...
                    <div className='displayRezervationInfoPrice'>
                        <div className='displayRezervationInfoPersonHotelBox'>
                            ...
                            <div className='hotelBox' style={{color:'green'}}>{totalPrice} تومان</div>
                        </div>
                        <div className='displayRezervationInfoPersonHotelBox'>
